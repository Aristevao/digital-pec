...
public interface UserApi {
    ...
    @GetMapping
    @Operation(summary = "Find all users", description = "Returns a paginated list of all users")
    Page<UserDTO> findAll(Pageable pageable);

    @GetMapping("list")
    @Operation(summary = "List all active users", description = "Returns a list of all active users")
